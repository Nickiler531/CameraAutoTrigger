...
#define LED1 IOPORT_CREATE_PIN(PORTC, 0)
#define LED2 IOPORT_CREATE_PIN(PORTC, 1)
#define LED3 IOPORT_CREATE_PIN(PORTC, 2)
#define LED4 IOPORT_CREATE_PIN(PORTC, 4)
#define LED5 IOPORT_CREATE_PIN(PORTC, 5)
